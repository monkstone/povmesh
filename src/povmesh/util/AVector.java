...
public final class AVector {
     ...
     * @param v1
     */
    public AVector(final AVector v1) {
        this.x = v1.x;
        this.y = v1.y;
        this.z = v1.z;
    }
    ...
    static float dot(final AVector v1, final AVector v2) {
        return v1.x * v2.x + v1.y * v2.y + v1.z * v2.z;
    }

    static AVector mult(final AVector v, float scalar) {
        return new AVector(v.x * scalar, v.y * scalar, v.z * scalar);
    }

    static AVector sub(final AVector v1, final AVector v2) {
